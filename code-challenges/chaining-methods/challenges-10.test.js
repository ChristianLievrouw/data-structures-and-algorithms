...
const createServer = () => {
  app.get('/hello', (request, response) => response.send('Hello everyone'))
  app.get('/aboutMe', (request, response) => response.send('My name is Christian Lievrouw'))
  app.get('/favoriteFoods', (request, response) => response.send(['taco', 'pizza']))
