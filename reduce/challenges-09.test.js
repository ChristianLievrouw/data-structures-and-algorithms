...
const mapCurrentEvents = () => {
  currentEvents.news.map(event => new Event(event))
  return event;
}
...
function Event(obj){
  ...
  this.category = obj.news.category;
  this.summary = obj.news.description;
  this.img_url = obj.news.url;
  this.date = obj.news.published;
  this.title = obj.news.title;
}
